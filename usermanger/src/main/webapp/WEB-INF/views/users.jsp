...
<div id="userAdd" class="easyui-window" title="新增会员" data-options="modal:true,closed:true,iconCls:'icon-save',href:'/user/page/user-add'" style="width:450px;height:400px;padding:10px;">
        The window content.
</div>
...
function getSelectionsIds(){
	...
	var sels = userList.datagrid("getSelections");//获取选择的所有行的内容---json格式
	// [{id:xx,name:xx}{}]
	var ids = [];
	for(var i in sels){
		ids.push(sels[i].id);
